...
namespace Minecraft_Discord_Bot
{
    public class ServerPing
    {
        ...
        public async Task<PingPayload> Ping(string serverIP, string port)
        {
            Console.Title = "Minecraft Server Ping";
            PingPayload ping = new PingPayload();
            var client = new TcpClient();
            var task = client.ConnectAsync("155.94.175.147", 25565);
            ...
            try
            {
                ...
                ping = await Task.Factory.StartNew(() => JsonConvert.DeserializeObject<PingPayload>(json));
                if(ping != null)
                {
    ...
    public class PingPayload
    {
        ...
        public Newtonsoft.Json.Linq.JObject Description { get; set; }
